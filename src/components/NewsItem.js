    ...
    return (
      <div className='my-3'>
        <div className="card">
          ...
          <img src={!imageUrl ? "https://static.tnn.in/thumb/msid-92374610,imgsize-100,width-1280,height-720,resizemode-75/92374610.jpg" : imageUrl} className="card-img-top" alt="..." />
